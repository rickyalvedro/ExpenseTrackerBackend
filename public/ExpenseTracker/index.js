...
async function addNewExpense(e) {
  try {
    ...
    const response = await axios.post(
      "http://174.129.108.53:3000/expense/addexpense",
      expenseDetails,
...
function showLeaderBoard() {
  ...
  inputElement.onclick = async () => {
    ...
    const userLeaderBoardArray = await axios.get(
      "http://174.129.108.53:3000/premium/showLeaderBoard",
      { headers: { Authorization: token } }
    );
...
async function getDOMpage() {
  try {
    ...
    const response = await axios.get(
      `http://174.129.108.53:3000/expense/getexpenses?limit=${LIMIT}&page=${PAGE}`,
      { headers: { Authorization: token } }
    );
...
async function getexpensepage(e) {
  ...
  try {
    let response = await axios.get(
      `http://174.129.108.53:3000/expense/getexpenses?limit=${LIMIT}&page=${e.target.innerHTML}`,
      { headers: { Authorization: token } }
    );
...
async function deleteExpense(e, expenseid) {
  try {
    ...
    await axios.delete(
      `http://174.129.108.53:3000/expense/deleteexpense/${expenseid}`,
      { headers: { Authorization: token } }
    );
...
async function download() {
  try {
    const token = localStorage.getItem("token");
    const response = await axios.get(
      "http://174.129.108.53:3000/expense/download",
      {
        headers: { Authorization: token },
      }
    );
...
document.getElementById("rzp-button1").onclick = async function (e) {
  const token = localStorage.getItem("token");
  const response = await axios.get(
    "http://174.129.108.53:3000/purchase/premiummembership",
    { headers: { Authorization: token } }
  );
  ...
  var options = {
    ...
    handler: async function (response) {
      await axios.post(
        "http://174.129.108.53:3000/purchase/updatetransactionstatus",
        {
